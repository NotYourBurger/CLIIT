...
Closed as completed with commit, test, and byte-census evidence after a fresh
continuation independently re-ran the suite (13 files), `issue check` (silent
at exit 0), and the allocator self-check.

## Next

Nothing. ISS-034 is next in the run.
